...
class MacroRecorder:
    ...
    Attributes:
        ...
        _running_macro: The macro commands which are running
        _running_win_id: The win_id of the running macro
    ...
    def run_commands(self):
        if len(self._running_macro) > 0:
            cmd = self._running_macro.pop(0)
